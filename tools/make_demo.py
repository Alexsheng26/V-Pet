...
class Demo:
    ...
    def _enter_phase(self, action: str | None) -> None:
        ...
        if action == "walk":
            ...
            b.next_switch = 99.0
        elif action in ("lift_low", "lift_wall"):
            b.grab()
        elif action == "stick":
            b.release()
    ...
    def _hold(self, action: str | None, dt: float) -> None:
        ...
        if action == "lift":
            ...
            # 贴到左墙、并且离地够高 —— release() 的贴墙判定要求这两条
            b.drag_to(max(2.0, b.x - 900 * dt), max(70.0, b.y - 340 * dt))
        elif action == "flick":
...
def main() -> int:
    ...
    want = {"idle", "walk", "drag", "fall", "dizzy", "happy", "crossed", "sleep", "curious", "cling"}
